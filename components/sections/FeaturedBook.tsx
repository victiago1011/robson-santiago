  ...
  return (
    <section aria-labelledby="livro-heading" className="bg-paper">
      <div className="mx-auto grid max-w-[90rem] px-6 py-14 md:px-8 md:py-20 lg:grid-cols-12 lg:items-center lg:gap-x-12 lg:px-12 lg:py-24 xl:px-16">
        <figure className="mx-auto w-full max-w-[15rem] justify-self-center md:max-w-[18rem] lg:col-span-6 lg:col-start-1 lg:max-w-[22rem] xl:max-w-[24rem]">
          <Image
        ...
        <div className="mt-8 lg:col-span-5 lg:col-start-8 lg:row-start-1 lg:mt-0">
